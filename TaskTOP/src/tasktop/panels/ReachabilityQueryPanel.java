...
public class ReachabilityQueryPanel extends JPanel  {
	...
	public ReachabilityQueryPanel(TransformationEngine te) {
		...
		statementPanel = new StatementPanel("be");
		
		canQuestionPanel.add(new JLabel("Can"));
		...
		chkNegate.addItemListener(new ItemListener() {
			...
			public void itemStateChanged(ItemEvent e) {
				...
				statementPanel.SetConnector(negate ? "not be" : "be");
			}
		});
